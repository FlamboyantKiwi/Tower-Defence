...
# 2 Options:
TOWERS.update(new_towers) #adds extra towers (and keeps original) 
# TOWERS = new_towers   # Overrides Towers (and replace the defaults)

# Adding Custom Maps - pass into GameManager to use
New_Level = [ 
...
#Add Tower Images: add tower_type.image_file to super().__init__()
# NOTE: Must add image_file to the TOWERS dictionary.
# NOTE: Also assumes they are in a folder called 'Assets' (can change in TowerBase: line 9)
